...
include::configuration/datastores/index.adoc[leveloffset=1]
include::configuration/datastores/clickhouse.adoc[leveloffset=2]
include::configuration/datastores/postgresql.adoc[leveloffset=2]

include::configuration/analytics/index.adoc[leveloffset=1]
include::configuration/analytics/none.adoc[leveloffset=2]
include::configuration/analytics/clickhouse.adoc[leveloffset=2]
include::configuration/analytics/postgresql.adoc[leveloffset=2]
// include::configuration/analytics/google_analytics.adoc[leveloffset=2]
include::configuration/analytics/custom.adoc[leveloffset=2]

include::configuration/secret/index.adoc[leveloffset=1]
include::configuration/secret/aws_secrets_manager.adoc[leveloffset=2]
include::configuration/secret/gcp_secret_manager.adoc[leveloffset=2]
