...
Writes events to a link:https://clickhouse.com/[ClickHouse] table using its native batch insert.  ClickHouse is well suited to this workload since analytics events are append-only, high volume, and usually queried in aggregate.
