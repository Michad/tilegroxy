...
This can only be used with layers that return JPEG or PNG images. Tiles will be scaled up to the highest resolution of the inputs to be combined and the combined result always output in PNG format.
