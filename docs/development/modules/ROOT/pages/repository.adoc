...
Contains a Helm chart for installing tilegroxy on kubernetes
...
Contains end-to-end tests that run the compiled binary as a child process.  Nothing in here is imported by the rest of the application, it exists solely to exercise the built artifact.
