...
lint:
	...
	@golangci-lint run --fix -E asciicheck,bidichk,bodyclose,canonicalheader,dogsled,exhaustive,gocheckcompilerdirectives,gocritic,godox,gofmt,durationcheck,errname,errorlint,fatcontext,goheader,interfacebloat,intrange,maintidx,makezero,mirror,misspell,nonamedreturns,prealloc,predeclared,testifylint,unconvert,wastedassign
